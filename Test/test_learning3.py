...
network.save_dictionary(5, 10, dict1_path, line_color = 255, data_path = file_path + '/orig_data.csv')
...
network.train(alpha_decay, alpha_decay_rate, alpha_decay_iters, clamp_proc=True)
network.plot_rmse(win1, win2)
network.plot_decay()
#Save out trained dictionary
network.save_dictionary(5, 10, dict2_path, line_color = 255, train=True, data_path = dict3_path)
